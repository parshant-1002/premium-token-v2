    ...
    <>
      ...
      <section className="position-relative roadMap_sec">
        ...
        <div className="container">
          ...
          <div className="road_title text-left">
        ...
        <div className="roadmap_wrap">
          <svg className="line-before" width="221" height="31" viewBox="0 0 221 31" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="premium_token_bg d-none d-lg-block">
          <img width={749} height={882} className="img-fluid" alt="background" src={ICONS.RoadMapBG} />
        </div>
      </section>
    </>
  );
